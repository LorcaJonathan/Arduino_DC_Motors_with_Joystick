...
int speedPin1 = 11;     // Pin de velocidad del motor 1
int dirPin1 = 8;       // Pin de dirección 1 del motor 1
int dirPin2 = 9;       // Pin de dirección 2 del motor 1

int speedPin2 = 10;     // Pin de velocidad del motor 2
int dirPin3 = 6;       // Pin de dirección 1 del motor 2
int dirPin4 = 7;       // Pin de dirección 2 del motor 2
...
void loop() {
  ...
  if (readValue < 400) {    // Si el valor del joystick es menor a 400 del eje Y
    ...
    digitalWrite(dirPin3, HIGH);     // Establecer dirección 1 del motor 2 como HIGH
    digitalWrite(dirPin4, LOW);      // Establecer dirección 2 del motor 2 como LOW
  }
  else if (readValue < 600) {
    digitalWrite(dirPin1, LOW);      // Establecer dirección 1 del motor 1 como LOW
    digitalWrite(dirPin2, LOW);      // Establecer dirección 2 del motor 1 como LOW
    
    digitalWrite(dirPin3, LOW);      // Establecer dirección 1 del motor 2 como LOW
    digitalWrite(dirPin4, LOW);      // Establecer dirección 2 del motor 2 como LOW
  }
  else {
    digitalWrite(dirPin1, LOW);      // Establecer dirección 1 del motor 1 como LOW
    ...
    digitalWrite(dirPin3, LOW);      // Establecer dirección 1 del motor 2 como LOW
    digitalWrite(dirPin4, HIGH);     // Establecer dirección 2 del motor 2 como HIGH
  }
}
